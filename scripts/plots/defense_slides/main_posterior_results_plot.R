...
save_plot_target_asp(filename = path(defense_figures_dir, "main_posterior_results_plot", ext = "pdf"),
...
save_plot_target_asp(filename = path(defense_figures_dir, "reproduction_number_plot", ext = "pdf"),
                     plot = plot_grid(R0_plot, Rt_plot, ncol = 1, align = "hv"),
                     ncol = 1,
                     nrow = 2,
                     device = cairo_pdf,
                     base_height = 3
...
save_plot_target_asp(filename = path(defense_figures_dir, "reproduction_number_plot", ext = "pdf"),
                     plot = plot_grid(R0_plot, Rt_plot, ncol = 2, align = "hv"),
                     ncol = 1,
                     nrow = 2,
                     device = cairo_pdf,
                     base_height = 3
...
save_plot_target_asp(filename = path(defense_figures_dir, "r_t_plot", ext = "pdf"),
                     plot = Rt_plot,
                     ncol = 1,
                     nrow = 1,
                     device = cairo_pdf
...
save_plot_target_asp(filename = path(defense_figures_dir, "alpha_plot", ext = "pdf"),
                     plot = plot_grid(alpha_plot, cumulative_latent_case_ratio_plot, ncol = 1, align = "hv"),
                     ncol = 1,
                     nrow = 2,
                     device = cairo_pdf,
                     base_height = 3
