...
forecast_crps_plot <-
  ...
  scale_y_continuous("Continuous Ranked Probability Score") +
  ...
  ggtitle("Continuous Ranked Probability Score Comparison", subtitle =  "Lower is better")


save_plot_target_asp(
  filename = path(defense_figures_dir, "forecast_crps_plot", ext = "pdf"),
