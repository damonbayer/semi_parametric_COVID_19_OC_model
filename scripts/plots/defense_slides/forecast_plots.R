...
save_plot_target_asp(
  filename = path(defense_figures_dir, "deaths_forecast_plot", ext = "pdf"),
...
save_plot_target_asp(
  filename = path(defense_figures_dir, "test_positivity_forecast_plot", ext = "pdf"),
...
save_plot_target_asp(
  filename = path(defense_figures_dir, "combined_forecast_plot", ext = "pdf"),
