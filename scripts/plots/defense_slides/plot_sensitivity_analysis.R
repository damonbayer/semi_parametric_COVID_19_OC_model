...
all_generated_quantities <- 
  bind_rows(
    ...
    tibble(full_path = dir_ls("results/tidy_prior_generated_quantities"),
           model_type = "prior")) %>% 
...
save_plot_target_asp(filename = path(defense_figures_dir, "scalar_sensitivity_plot", ext = "pdf"),
          plot = scalar_sensitivity_plot,
          ncol = 4, nrow = 3, base_asp = 1, base_height = 2.5,
          device = cairo_pdf)

save_plot_target_asp(filename = path(defense_figures_dir, "compartments_sensitivity_plot", ext = "pdf"),
          plot = compartments_sensitivity_plot,
          ncol = 5, nrow = 5, base_height = 1.5,
          device = cairo_pdf)

save_plot_target_asp(filename = path(defense_figures_dir, "time_varying_sensitivity_plot", ext = "pdf"),
