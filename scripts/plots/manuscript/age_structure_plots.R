...
save_plot(
  filename = path(figures_dir, "posterior_predictive_ifr_age_structure_plot", ext = "pdf"),
...
save_plot(
  filename = path(figures_dir, "ifr_age_structure_generated_quantities_simulation_scalar_plot", ext = "pdf"),
...
save_plot(
  filename = path(figures_dir, "ifr_age_structure_generated_quantities_simulation_time_varying_plot", ext = "pdf"),
...
save_plot(
  filename = path(figures_dir, "ifr_age_structure_generated_quantities_simulation_compartment_plot", ext = "pdf"),
