...
@model function bayes_seird_fixed_phi(data_new_deaths, data_new_cases, tests, data_seroprev_cases, seroprev_tests, obstimes, seroprev_times, param_change_times, use_tests, use_seroprev, constant_R0, constant_alpha, constant_IFR, extra_ode_precision)
  ...
  ϕ_cases_non_centered = fixed_ϕ_cases_non_centered
  ϕ_deaths_non_centered = fixed_ϕ_deaths_non_centered
